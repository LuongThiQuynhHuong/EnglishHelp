...
export type VocabularyRow = {
  id: string; word: string; vietnamese_meaning: string; english_meaning: string; image_url: string | null;
...
export function toVocabulary(row: VocabularyRow): Vocabulary {
  return {
    id: row.id, word: row.word, vietnameseMeaning: row.vietnamese_meaning, englishMeaning: row.english_meaning,
